...
public final class Op {
    ...
    public static String name(int op) {
        return switch (op) {
            case MOV -> "MOV"; case LDI -> "LDI"; case LDIQ -> "LDIQ";
            case ADD32 -> "ADD32"; case SUB32 -> "SUB32"; case MUL32 -> "MUL32"; case REM32 -> "REM32";
            case AND32 -> "AND32"; case OR32 -> "OR32"; case XOR32 -> "XOR32";
            case SHL32 -> "SHL32"; case SHR32 -> "SHR32"; case ROL32 -> "ROL32"; case ROR32 -> "ROR32";
            case ADD64 -> "ADD64"; case MUL64 -> "MUL64"; case SHR64 -> "SHR64"; case XOR64 -> "XOR64";
            case SEXT8 -> "SEXT8"; case SEXT32 -> "SEXT32";
            case LDB -> "LDB"; case LDBS -> "LDBS"; case STB -> "STB";
            case LDW -> "LDW"; case STW -> "STW";
            case LDQ -> "LDQ"; case STQ -> "STQ";
            case SBOX -> "SBOX";
            case JMP -> "JMP"; case JZ32 -> "JZ32"; case JNZ32 -> "JNZ32";
            case JEQ32 -> "JEQ32"; case JNE32 -> "JNE32";
            case JLT32 -> "JLT32"; case JGE32 -> "JGE32"; case JGT32 -> "JGT32"; case JLE32 -> "JLE32";
            case JLTU32 -> "JLTU32"; case JGEU32 -> "JGEU32"; case JGTU32 -> "JGTU32"; case JLEU32 -> "JLEU32";
            case RET -> "RET";
